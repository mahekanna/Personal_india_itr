...
| US stock plan and brokerage | XLSX, XLS, CSV | Vesting tranches, **ESPP purchases**, dividends and reinvestment, disposals — from E*TRADE, Fidelity, Schwab and Morgan Stanley StockPlan Connect |
...
The tax engine has 108 golden tests whose expected values were worked out by hand
